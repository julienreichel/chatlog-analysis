<template>
  <div class="api-keys-page">
    ...
    <div v-else-if="keys.length === 0" class="empty" data-testid="empty-keys">
...
const { keys, loading, creating, revoking, errorMsg, newKey, fetchKeys, createKey, revokeKey } = useApiKeys()
